...
/* ==================== GPIO Control ==================== */
#define OLED_CS_LOW()         GPIOA_BSRR = (1 << 20)
#define OLED_CS_HIGH()        GPIOA_BSRR = (1 << 4)
#define OLED_DC_LOW()         GPIOA_BSRR = (1 << 19)
#define OLED_DC_HIGH()        GPIOA_BSRR = (1 << 3)
#define OLED_RST_LOW()        GPIOA_BSRR = (1 << 18)
#define OLED_RST_HIGH()       GPIOA_BSRR = (1 << 2)
